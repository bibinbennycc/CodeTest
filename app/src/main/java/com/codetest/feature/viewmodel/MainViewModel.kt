...
class MainViewModel @Inject constructor(private val mainRepository: MainRepository, context: Context) : ViewModel() {
    ...
    fun updateLocation(location: Location){
        val locations : ArrayList<Location> = _locationResponse.value?.data?.locations  ?: arrayListOf()
    ...
    fun getLocations() {
        viewModelScope.launch {
            setLocations(Resource.loading(data = null))
